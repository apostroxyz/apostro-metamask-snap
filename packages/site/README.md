...
By default you can use the `SNAP_ORIGIN` variable (used in `src/config/snap.ts`) to define a development or production origin for your snap (eg. `npm:MyPackageName`). If not defined it will defaults to `local:http://localhost:8080`.
